						...
						<div class="right-content bgwhite fr">
							...
							<section class="uic-section-tb hide">
								<form id="frmUIC2" action="#" method="post" enctype="multipart/form-data" >
									...
									<div class="clear" style="padding-top:1em;width:15em;">
										<div class="fl w60">
											<input type="text" name="txtshare1" id="txtshare1" value="Don't share" placeholder="Don't share">
										</div>
									</div>
									<div class="clear" style="padding-top:0.5em"></div>
							...
							<section class="uic-section-box hide">
								<form id="frmUIC3" action="#" method="post" enctype="multipart/form-data" >
									...
									<input type="text" data-clear-btn="true" name="txtbox22" id="txtbox22" value="Press the &quot;yes&quot; button to share. By sharing you agree with Camrally's <privacy_policy_link>." placeholder="Press the &quot;yes&quot; button to share. By sharing you agree with Camrally's <privacy_policy_link>.">

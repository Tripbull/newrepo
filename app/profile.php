						...
						<div class="right-content bgwhite fr">
							...
							<section class="pro-section hide">
								...
								<input type="text" data-clear-btn="false" name="txtweb" id="txtweb" value="" placeholder="website url (optional)">
									...
									<label for="number-1"></label>
									<input type="text" data-clear-btn="false" name="txtbooknowlabel" id="txtbooknowlabel" value="Post Your Photo!" placeholder="custom button (optional)" style="background-color: #C7E6F5;">

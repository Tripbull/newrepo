...
$(document).ready(function(){
	...
	$.fancybox({'scrolling':'no','closeEffect':'fade','closeClick':false,'overlayColor': '#000','href' :'#betapermission','overlayOpacity': 0.5,'beforeClose':function(){window.location= "http://camrally.com";}});

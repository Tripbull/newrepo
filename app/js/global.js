...
function showHideMenu(row){
	...
	if(row == 0){
		$('.left-menu').html('<ul class="left-menu" data-role="listview"><li><a href="http://camrally.com/blog/getting-started-with-tabluu" data-prefetch="true" target="_blank">Getting Started<span class="listview-arrow-default"></span></a></li><li ><a href="http://camrally.com/blog/how-do-i-setup-tabluu-2" data-prefetch="true" target="_blank">Setup<span class="listview-arrow-default"></span></a></li><li ><a href="http://camrally.com/blog/some-examples-to-get-you-started" data-prefetch="true" target="_blank">Examples<span class="listview-arrow-default"></span></a></li></ul>');
	}else if(row == 1){

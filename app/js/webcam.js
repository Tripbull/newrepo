...
var Webcam = {
	...
	detectFlash: function() {
		...
		// Code snippet borrowed from: http://github.com/swfobject/swfobject
	...
	getSWFHTML: function() {
		...
		if (!this.detectFlash()) {
			...
			return '<h3 style="color:red">ERROR: No Adobe Flash Player detected. Please go to <a href="http://get.adobe.com/flashplayer/">http://get.adobe.com/flashplayer/</a> to install Adobe Flash Player to continue using Tabluu. Alternatively, please open this link using another browser like Chrome, Firefox or Opera.</h3>';
		}
	...
	b64ToUint6: function(nChr) {
		...
		// from: http://developer.mozilla.org/en-US/docs/Web/JavaScript/Base64_encoding_and_decoding

					...
					<div class="main-wrap">
						...
						<div class="right-content right-bgblue fr">
							...
							<section class="right-menu-loc hide">
								<ul class="right-menu-loc" data-role="listview"><li ><a href="#" id="setup-custom" data-prefetch="false">Setup<span class="listview-arrow-default"></span></a></li><li id="visit-tabluu-page"><a href="#" target="_blank" class="link-visit-page" data-prefetch="false">See Your Camrally Page<span class="listview-arrow-default"></span></a></li><li ><a href="#" id="collectFeedback" data-prefetch="false">Mini Link (to Rally for Advocates)<span class="listview-arrow-default"></span></a></li><li><a href="#" id="manageFeedback" data-prefetch="true">Manage Advocates<span class="listview-arrow-default"></span></a></li><li ><a href="#" id="change-icon" data-prefetch="false">Change Status<span class="listview-arrow-default"></span></a></li><li ><a href="#" id="del-place" data-prefetch="false">Delete<span class="listview-arrow-default"></span></a></li></ul>
							</section>								
						</div>
					</div>					
				</div><!-- /content -->

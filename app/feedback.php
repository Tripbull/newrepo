					...
					<div class="main-wrap">
						...
						<div class="right-content bgwhite fr">
							...
							<section class="tellafriend hide">
								<!--<iframe src="http://camrally.com/tellafriend/index.php" width="600" height="600" scrolling="auto" frameborder="0" style="border:0px #FFFFFF" name="frame share contacts" id="tellFrame" marginheight="0"></iframe>-->

...
//   'redirect_uri' => 'http://camrally.com/staging/youtubeapi.html', //this doesn't do anything, but it's validated so i needs to match what you've been using  
...
<html>
	<head>
        ...
        <script>
        	var resizeTimeout,beforeSubmit,getVideoId,getStatus, getPlaceId, getTypevid, getTitleVid, getUrlVid;

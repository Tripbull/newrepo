...
<title>Camrally - your awesome tool to get user generated content for social media marketing</title>
<meta name="title" content="Camrally is an awesome tool to get user generated content for social media marketing">
...
<?php require_once('header.html'); ?>
  ...
  <div class="container">
      <div class="qrcode-content" style="margin-top:30px;">
        <div class="cust-post"> 
       <h4 class="plan-title">Create your own photo campaign in <br>10 mins & change the world. It’s free!</h4>
          ...
          <div class="text-left div-p cam-selfie">
            <p>Camrally is an online service for creating & running photo & selfie campaigns. Start a campaign today to better your community, your society and your country. Camrally empowers you to change the world, one snap at a time!</p> 
            <div class="clear" style="padding:0.7em 0;"></div>
            <p>Camrally is also great for fundraising, fanbase building, event promotion, photo contest, new product launch and marketing promotion. Create an interest group or use Camrally “just for fun”. It’s like having Causes.com, Pinterest & Instagram combined! Start a campaign and rally support for anything. Anything at all!! With Camrally, you are limited only by your own creativity!</p>
          </div>
          <div class="clear" style="padding:1em 0;"></div>
          <div class="tblcontainer">
            <div class="row">
...
<div class="container">
  <div class="qrcode-content">
    <div class="cust-post">
       <h4 class="plan-title">So sophisticated, yet easy to use, <br>anyone can run a successful campaign!</h4>
       <div class="clear" style="padding:1em 0;"></div>
      <!-- <div class="hidden-xs"> -->
        <div class="tblcontainer">
          <div class="row" style="margin-right:40px;">
            ...
            <div class="poster-right check-list-ul">
              <ul>
                ...
                <li>Proactively ask advocates to share to Facebook &amp; Twitter.</li>
                <li>Get &amp; promote a mini link that directs to your Camrally campaign page.</li>
              </ul>
            </div>
          </div>
        </div>
...
<div class="container">
  <div class="qrcode-content">
    <div class="cust-post">
       <h4 class="plan-title">No hashtags. No problems.</h4>
       <div class="clear" style="padding:1em 0;"></div>
      <!-- <div class="hidden-xs"> -->
        <div class="tblcontainer">
          <div class="row">
        ...
        <div class="cam-fail">
          <ul>
            ...
            <li>No need to provide elaborate instructions on what hashtags to use</li>
...
<div class="container">
  <div class="qrcode-content">
    <div class="cust-post">
       <h4 class="plan-title">Get your own “Pinterest-like” page! </h4>
       <div class="clear" style="padding:1em 0;"></div>
      <!-- <div class="hidden-xs"> -->
        <div class="tblcontainer">
          <div class="row">
        ...
        <div class="cam-fail">
          <ul>
            <li>If you don’t have any social media pages, you don’t need one now.</li>
            <li>All your advocates’ photo posts in one page!</li>
            <li>All posts link to the social media account of your advocates.</li>
            <li>Showcase relevant images of your campaign.</li>
            <li>It’s an all in one page for all your campaign details & relevant links.</li>
...
<div class="container">
  <div class="qrcode-content">
    <div class="cust-post">
       <h4 class="plan-title">Sometimes, you just got to hit the brakes…</h4>
       <div class="clear" style="padding:1em 0;"></div>
      <!-- <div class="hidden-xs"> -->
        <div class="tblcontainer">
          <div class="row">
